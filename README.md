...
This uses a number of node.js tools to initialize and test app. You must have node.js and
...
this app changes this location through the `.bowerrc` file.  Putting it in the app folder makes
...
Previously we recommended that you merge in changes to app into your own fork of the project.
...
to your repository and execute scripts such as building the app or running tests. The project contains a Travis configuration file, `.travis.yml`, which will cause Travis to run your
